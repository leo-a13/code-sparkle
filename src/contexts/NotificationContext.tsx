...
const DEFAULT_NOTIFICATIONS: Notification[] = [
  {
    id: '1', title: 'Water Reminder',
    message: "Don't forget to drink water! You're 2 cups behind your goal.",
    type: 'water', isRead: false, timestamp: new Date(Date.now() - 60000),
  },
  {
    id: '2', title: 'New Badge Earned',
    message: "Congratulations! You've earned the 'Protein Champion' badge.",
    type: 'achievement', isRead: false, timestamp: new Date(Date.now() - 7200000),
  },
  {
    id: '3', title: 'Meal Plan Updated',
    message: 'Your meal plan for the week has been updated.',
    type: 'meal', isRead: false, timestamp: new Date(Date.now() - 86400000),
  },
  {
    id: '4', title: 'Achievement Unlocked!',
    message: "You've completed 5 consecutive days of logging your meals.",
    type: 'achievement', isRead: false, timestamp: new Date(Date.now() - 172800000),
  },
  {
    id: '5', title: 'Reminder: Step Goal',
    message: 'You are 1,500 steps away from hitting your daily target.',
    type: 'reminder', isRead: false, timestamp: new Date(Date.now() - 259200000),
  },
];
...
export const NotificationProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <NotificationContext.Provider value={{
      ...
      markAllAsRead, clearNotifications, deleteNotification,
    }}>
      {children}
